...
export function buildLpFaqItems(lpKeyword) {
  return [
    {
      question: `Why might I need ${lpKeyword}?`,
    ...
    {
      question: `How is pricing handled for ${lpKeyword}?`,
    ...
    {
      question: `What timeline should I expect for ${lpKeyword}?`,
    ...
    {
      question: `Do you offer warranties on ${lpKeyword}?`,
    ...
    {
      question: `Why choose Mile High Gutter for ${lpKeyword}?`,
